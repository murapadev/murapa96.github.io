...
//Read prefers-color-scheme and set dark mode if it is dark on local storage
window.addEventListener("load", () => {
  if (
    window.matchMedia("(prefers-color-scheme: dark)").matches &&
    localStorage.getItem("changed_by_system") !== "true"
  ) {
    localStorage.setItem("changed_by_system", true);
